...
if __name__ == "__main__":
    ...
    # OC solver
    sys_pdp = CPDP.COCSys()
    sys_pdp.setAuxvarVariable(vertcat(rocket.dyn_auxvar, rocket.cost_auxvar))
    sys_pdp.setStateVariable(rocket.X)
    sys_pdp.setControlVariable(rocket.U)
    dyn = rocket.f
    sys_pdp.setDyn(dyn)
    sys_pdp.setPathCost(rocket.path_cost)   
    sys_pdp.setFinalCost(rocket.final_cost)
    ...
    sys_zorms.setParamVariable(vertcat(rocket.dyn_auxvar, rocket.cost_auxvar))
